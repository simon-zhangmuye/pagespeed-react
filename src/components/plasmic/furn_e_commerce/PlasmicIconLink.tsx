...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: n1q1P7iULA40pt/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__oEijd)}
              role={"img"}
            />
          ),
